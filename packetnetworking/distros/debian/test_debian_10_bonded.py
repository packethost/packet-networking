...
@pytest.fixture
def debian_10_bonded_network(generic_debian_bonded_network):
    def _builder(**kwargs):
        return generic_debian_bonded_network("debian", "10", **kwargs)

    return _builder


def test_debian_10_public_bonded_task_etc_network_interfaces(debian_10_bonded_network):
    """Validates /etc/network/interfaces for a public bond"""

    builder = debian_10_bonded_network(public=True)
...
def test_debian_10_private_bonded_task_etc_network_interfaces(debian_10_bonded_network):
    ...
    """
    builder = debian_10_bonded_network(public=False)
    tasks = builder.render()
    result = dedent(
        """\
        auto lo
...
def test_debian_10_public_bonded_task_etc_network_interfaces_with_custom_private_ip_space(
    ...
    builder = debian_10_bonded_network(public=True, metadata=subnets)
    tasks = builder.render()
    result = dedent(
        """\
        auto lo
...
def test_debian_10_private_bonded_task_etc_network_interfaces_with_custom_private_ip_space(
    ...
    """
    subnets = {"private_subnets": ["192.168.5.0/24", "172.16.0.0/12"]}
    builder = debian_10_bonded_network(public=False, metadata=subnets)
    tasks = builder.render()
    result = dedent(
        """\
        auto lo
...
def test_debian_10_task_etc_modules(debian_10_bonded_network):
...
def test_debian_10_etc_hostname_configured(debian_10_bonded_network):
    """
...
def test_debian_10_etc_hosts_configured(debian_10_bonded_network):
    """
