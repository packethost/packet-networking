...
@pytest.fixture
def debian_11_individual_network(generic_debian_individual_network):
    def _builder(**kwargs):
        return generic_debian_individual_network("debian", "11", **kwargs)
...
def test_debian_11_public_individual_task_etc_network_interfaces(
    ...
    builder = debian_11_individual_network(public=True)
...
def test_debian_11_private_individual_task_etc_network_interfaces(
    ...
    """
    builder = debian_11_individual_network(public=False)
    tasks = builder.render()
    result = dedent(
        """\
        auto lo
...
def test_debian_11_public_individual_task_etc_network_interfaces_with_custom_private_ip_space(
    ...
    builder = debian_11_individual_network(public=True, metadata=subnets)
    tasks = builder.render()
    result = dedent(
        """\
        auto lo
...
def test_debian_11_private_individual_task_etc_network_interfaces_with_custom_private_ip_space(
    ...
    """
    subnets = {"private_subnets": ["192.168.5.0/24", "172.16.0.0/12"]}
    builder = debian_11_individual_network(public=False, metadata=subnets)
    tasks = builder.render()
    result = dedent(
        """\
        auto lo
...
def test_debian_11_etc_resolvers_configured(debian_11_individual_network, fake):
    """
...
def test_debian_11_etc_hostname_configured(debian_11_individual_network):
    """
...
def test_debian_11_etc_hosts_configured(debian_11_individual_network):
    """
