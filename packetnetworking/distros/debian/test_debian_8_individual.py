...
def test_debian_8_public_individual_task_etc_network_interfaces(
    ...
    builder = debian_8_individual_network(public=True)
...
def test_debian_8_private_individual_task_etc_network_interfaces(
    ...
    """
    builder = debian_8_individual_network(public=False)
    tasks = builder.render()
    result = dedent(
        """\
        auto lo
...
def test_debian_8_public_individual_task_etc_network_interfaces_with_custom_private_ip_space(
    ...
    builder = debian_8_individual_network(public=True, metadata=subnets)
    tasks = builder.render()
    result = dedent(
        """\
        auto lo
...
def test_debian_8_private_individual_task_etc_network_interfaces_with_custom_private_ip_space(
    ...
    """
    subnets = {"private_subnets": ["192.168.5.0/24", "172.16.0.0/12"]}
    builder = debian_8_individual_network(public=False, metadata=subnets)
    tasks = builder.render()
    result = dedent(
        """\
        auto lo
...
def test_debian_8_etc_resolvers_configured(debian_8_individual_network, fake):
    """
    Validates /etc/resolv.conf is configured correctly
    """
    builder = debian_8_individual_network()
    resolver1 = fake.ipv4()
    resolver2 = fake.ipv4()
...
def test_debian_8_etc_hostname_configured(debian_8_individual_network):
    """
...
def test_debian_8_etc_hosts_configured(debian_8_individual_network):
    """
...
def test_debian_8_no_persistent_interface_names(debian_8_individual_network):
    """
...
def test_debian_8_public_individual_dhcp_task_etc_network_interfaces(
    debian_8_individual_network,
...
def test_debian_8_etc_resolvers_dhcp(
    debian_8_individual_network, make_interfaces_dhcp_metadata
):
    """
