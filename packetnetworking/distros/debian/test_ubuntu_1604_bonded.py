...
@pytest.fixture
def ubuntu_1604_bonded_network(generic_debian_bonded_network):
    def _builder(**kwargs):
        return generic_debian_bonded_network("ubuntu", "16.04", **kwargs)

    return _builder


def test_ubuntu_1604_public_bonded_task_etc_network_interfaces(
    ubuntu_1604_bonded_network,
):
    """Validates /etc/network/interfaces for a public bond"""

    builder = ubuntu_1604_bonded_network(public=True)
...
def test_ubuntu_1604_private_bonded_task_etc_network_interfaces(
    ubuntu_1604_bonded_network,
):
    """
    ...
    """
    builder = ubuntu_1604_bonded_network(public=False)
    tasks = builder.render()
    result = dedent(
        """\
        auto lo
...
# pylama:ignore=E501
def test_ubuntu_1604_public_bonded_task_etc_network_interfaces_with_custom_private_ip_space(
    ubuntu_1604_bonded_network,
):
    """Validates /etc/network/interfaces for a public bond"""
...
def test_ubuntu_1604_private_bonded_task_etc_network_interfaces_with_custom_private_ip_space(
    ubuntu_1604_bonded_network,
):
    """
    When no public ip is assigned, we should see the private ip details in the
...
def test_ubuntu_1604_task_etc_modules(ubuntu_1604_bonded_network):
...
def test_ubuntu_1604_etc_resolvers_configured(ubuntu_1604_bonded_network, fake):
    ...
    """
    builder = ubuntu_1604_bonded_network()
    resolver1 = fake.ipv4()
    resolver2 = fake.ipv4()
...
def test_ubuntu_1604_etc_hostname_configured(ubuntu_1604_bonded_network):
    """
...
def test_ubuntu_1604_etc_hosts_configured(ubuntu_1604_bonded_network):
    """
...
def test_ubuntu_1604_no_persistent_interface_names(ubuntu_1604_bonded_network):
    """
