...
@pytest.fixture
def ubuntu_1604_individual_network(generic_debian_individual_network):
    def _builder(**kwargs):
        return generic_debian_individual_network("ubuntu", "16.04", **kwargs)

    return _builder


def test_ubuntu_1604_public_individual_task_etc_network_interfaces(
    ubuntu_1604_individual_network,
):
    """Validates /etc/network/interfaces for a public bond"""

    builder = ubuntu_1604_individual_network(public=True)
...
def test_ubuntu_1604_private_individual_task_etc_network_interfaces(
    ubuntu_1604_individual_network,
):
    """
    ...
    """
    builder = ubuntu_1604_individual_network(public=False)
    tasks = builder.render()
    result = dedent(
        """\
        auto lo
...
# pylama:ignore=E501
def test_ubuntu_1604_public_individual_task_etc_network_interfaces_with_custom_private_ip_space(
    ubuntu_1604_individual_network,
):
    """Validates /etc/network/interfaces for a public bond"""
    subnets = {"private_subnets": ["192.168.5.0/24", "172.16.0.0/12"]}
    builder = ubuntu_1604_individual_network(public=True, metadata=subnets)
    tasks = builder.render()
    result = dedent(
        """\
        auto lo
...
def test_ubuntu_1604_private_individual_task_etc_network_interfaces_with_custom_private_ip_space(
    ubuntu_1604_individual_network,
):
    """
    When no public ip is assigned, we should see the private ip details in the
    ...
    """
    subnets = {"private_subnets": ["192.168.5.0/24", "172.16.0.0/12"]}
    builder = ubuntu_1604_individual_network(public=False, metadata=subnets)
    tasks = builder.render()
    result = dedent(
        """\
        auto lo
...
def test_ubuntu_1604_etc_resolvers_configured(ubuntu_1604_individual_network, fake):
    """
...
def test_ubuntu_1604_etc_hostname_configured(ubuntu_1604_individual_network):
    """
...
def test_ubuntu_1604_etc_hosts_configured(ubuntu_1604_individual_network):
    """
...
def test_ubuntu_1604_no_persistent_interface_names(ubuntu_1604_individual_network):
    """
