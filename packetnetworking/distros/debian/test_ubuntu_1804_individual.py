...
def test_ubuntu_1804_public_individual_task_etc_network_interfaces_with_custom_private_ip_space(
    ...
    builder = ubuntu_1804_individual_network(public=True, metadata=routes)
    tasks = builder.render()
    result = dedent(
        """\
        auto lo
...
def test_ubuntu_1804_private_individual_task_etc_network_interfaces_with_custom_private_ip_space(
    ...
    """
    routes = {"private_ip_space": ["192.168.5.0/24", "172.16.0.0/12"]}
    builder = ubuntu_1804_individual_network(public=False, metadata=routes)
    tasks = builder.render()
    result = dedent(
        """\
        auto lo
...
def test_ubuntu_1804_no_persistent_interface_names(ubuntu_1804_individual_network):
    """
