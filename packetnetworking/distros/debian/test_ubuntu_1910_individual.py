...
def test_ubuntu_1910_public_individual_dhcp_task_etc_network_interfaces(
    ubuntu_1910_individual_network,
...
def test_ubuntu_1910_etc_resolvers_dhcp(
    ubuntu_1910_individual_network, make_interfaces_dhcp_metadata
):
    """
