...
@pytest.fixture
def ubuntu_2204_bonded_network(generic_debian_bonded_network):
    def _builder(**kwargs):
        return generic_debian_bonded_network("ubuntu", "22.04", **kwargs)

    return _builder


def test_ubuntu_2204_public_bonded_task_etc_network_interfaces(
    ubuntu_2204_bonded_network,
):
    """Validates /etc/network/interfaces for a public bond"""

    builder = ubuntu_2204_bonded_network(public=True)
...
def test_ubuntu_2204_private_bonded_task_etc_network_interfaces(
    ubuntu_2204_bonded_network,
):
    """
    ...
    """
    builder = ubuntu_2204_bonded_network(public=False)
    tasks = builder.render()
    result = dedent(
        """\
        auto lo
...
def test_ubuntu_2204_public_bonded_task_etc_network_interfaces_with_custom_private_ip_space(
    ubuntu_2204_bonded_network,
):
    """Validates /etc/network/interfaces for a public bond"""
    subnets = {"private_subnets": ["192.168.5.0/24", "172.16.0.0/12"]}
    builder = ubuntu_2204_bonded_network(public=True, metadata=subnets)
    tasks = builder.render()
    result = dedent(
        """\
        auto lo
...
def test_ubuntu_2204_private_bonded_task_etc_network_interfaces_with_custom_private_ip_space(
    ubuntu_2204_bonded_network,
):
    """
    When no public ip is assigned, we should see the private ip details in the
    ...
    """
    subnets = {"private_subnets": ["192.168.5.0/24", "172.16.0.0/12"]}
    builder = ubuntu_2204_bonded_network(public=False, metadata=subnets)
    tasks = builder.render()
    result = dedent(
        """\
        auto lo
...
def test_ubuntu_2204_task_etc_modules(ubuntu_2204_bonded_network):
...
def test_ubuntu_2204_etc_hosts_configured(ubuntu_2204_bonded_network):
    """
...
def test_ubuntu_2204_persistent_interface_names(ubuntu_2204_bonded_network):
    """
