...
@pytest.fixture
def fedora_32_bonded_network(generic_redhat_bonded_network):
    def _builder(**kwargs):
        return generic_redhat_bonded_network("fedora", "32", **kwargs)

    return _builder


def test_fedora_32_public_bonded_task_etc_sysconfig_network(fedora_32_bonded_network):
    """Validates /etc/sysconfig/network for a public bond"""
    builder = fedora_32_bonded_network(public=True)
...
def test_fedora_32_private_bonded_task_etc_sysconfig_network(fedora_32_bonded_network):
    """Validates /etc/sysconfig/network for a private only bond"""
    builder = fedora_32_bonded_network(public=False)
    tasks = builder.render()
    result = dedent(
        """\
        NETWORKING=yes
...
# pylama:ignore=E501
def test_fedora_32_bonded_task_etc_modprobe_d_bonding(fedora_32_bonded_network):
    """Validates /etc/modprobe.d/bonding.conf has correct bonding mode"""
    builder = fedora_32_bonded_network()
    tasks = builder.render()
    result = dedent(
        """\
        alias bond0 bonding
...
def test_fedora_32_public_bonded_task_etc_sysconfig_network_scripts_ifcfg_bond0(
...
def test_fedora_32_private_bonded_task_etc_sysconfig_network_scripts_ifcfg_bond0(
    fedora_32_bonded_network,
):
    """
...
def test_fedora_32_private_alias_task_etc_sysconfig_network_scripts_ifcfg_bond0_0(
    fedora_32_bonded_network,
):
    """
...
def test_fedora_32_private_alias_task_missing_for_private_only_bond(
    fedora_32_bonded_network,
):
    """
...
def test_fedora_32_private_route_task_etc_sysconfig_network_scripts_route_bond0(
    fedora_32_bonded_network,
):
    """
...
# pylama:ignore=E501
def test_fedora_32_private_route_task_etc_sysconfig_network_scripts_route_bond0_with_custom_private_subnets(
    fedora_32_bonded_network,
):
    """
    When using a public ip, the private ip is assigned as an alias, this
    ...
    builder = fedora_32_bonded_network(public=True, metadata=subnets)
    tasks = builder.render()
    result = dedent(
        """\
...
def test_fedora_32_private_route_task_missing_for_private_only_bond(
    fedora_32_bonded_network,
):
    """
...
def test_fedora_32_individual_interface_files_created(fedora_32_bonded_network):
    """
...
def test_fedora_32_etc_resolvers_configured(fedora_32_bonded_network, fake):
    """
...
def test_fedora_32_etc_hostname_configured(fedora_32_bonded_network):
    """
...
def test_fedora_32_etc_hosts_configured(fedora_32_bonded_network):
    """
...
def test_fedora_32_sbin_ifup_pre_local(fedora_32_bonded_network):
    """
...
def test_fedora_32_network_manager_is_disabled(fedora_32_bonded_network):
    """
...
def test_fedora_32_persistent_interface_names_does_not_exist(fedora_32_bonded_network):
    """
