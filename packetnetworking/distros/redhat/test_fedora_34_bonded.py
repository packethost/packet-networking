...
@pytest.fixture
def fedora_34_bonded_network(generic_redhat_bonded_network):
    def _builder(**kwargs):
        return generic_redhat_bonded_network("fedora", "34", **kwargs)

    return _builder


def test_fedora_34_public_bonded_task_etc_sysconfig_network(fedora_34_bonded_network):
    """Validates /etc/sysconfig/network for a public bond"""
    builder = fedora_34_bonded_network(public=True)
...
def test_fedora_34_private_bonded_task_etc_sysconfig_network(fedora_34_bonded_network):
    """Validates /etc/sysconfig/network for a private only bond"""
    builder = fedora_34_bonded_network(public=False)
    tasks = builder.render()
    result = dedent(
        """\
        NETWORKING=yes
...
# pylama:ignore=E501
def test_fedora_34_bonded_task_etc_modprobe_d_bonding(fedora_34_bonded_network):
    """Validates /etc/modprobe.d/bonding.conf has correct bonding mode"""
    builder = fedora_34_bonded_network()
    tasks = builder.render()
    result = dedent(
        """\
        alias bond0 bonding
...
def test_fedora_34_public_bonded_task_etc_sysconfig_network_scripts_ifcfg_bond0(
...
def test_fedora_34_private_bonded_task_etc_sysconfig_network_scripts_ifcfg_bond0(
    fedora_34_bonded_network,
):
    """
...
def test_fedora_34_private_alias_task_etc_sysconfig_network_scripts_ifcfg_bond0_0(
    fedora_34_bonded_network,
):
    """
...
def test_fedora_34_private_alias_task_missing_for_private_only_bond(
    fedora_34_bonded_network,
):
    """
...
def test_fedora_34_private_route_task_etc_sysconfig_network_scripts_route_bond0(
    fedora_34_bonded_network,
):
    """
...
# pylama:ignore=E501
def test_fedora_34_private_route_task_etc_sysconfig_network_scripts_route_bond0_with_custom_private_subnets(
    fedora_34_bonded_network,
):
    """
    When using a public ip, the private ip is assigned as an alias, this
    ...
    builder = fedora_34_bonded_network(public=True, metadata=subnets)
    tasks = builder.render()
    result = dedent(
        """\
...
def test_fedora_34_private_route_task_missing_for_private_only_bond(
    fedora_34_bonded_network,
):
    """
...
def test_fedora_34_individual_interface_files_created(fedora_34_bonded_network):
    """
...
def test_fedora_34_etc_resolvers_configured(fedora_34_bonded_network, fake):
    """
...
def test_fedora_34_etc_hostname_configured(fedora_34_bonded_network):
    """
...
def test_fedora_34_etc_hosts_configured(fedora_34_bonded_network):
    """
...
def test_fedora_34_sbin_ifup_pre_local(fedora_34_bonded_network):
    """
...
def test_fedora_34_network_manager_is_disabled(fedora_34_bonded_network):
    """
...
def test_fedora_34_persistent_interface_names_does_not_exist(fedora_34_bonded_network):
    """
