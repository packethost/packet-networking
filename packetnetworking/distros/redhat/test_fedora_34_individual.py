...
@pytest.fixture
def fedora_34_individual_network(generic_redhat_individual_network):
    def _builder(**kwargs):
        return generic_redhat_individual_network("fedora", "34", **kwargs)

    return _builder


def test_fedora_34_public_individual_task_etc_sysconfig_network(
    fedora_34_individual_network,
):
    """Validates /etc/sysconfig/network for a public bond"""
    builder = fedora_34_individual_network(public=True)
...
def test_fedora_34_public_individual_task_etc_sysconfig_network_scripts_ifcfg_enp0(
    fedora_34_individual_network,
):
...
def test_fedora_34_private_individual_task_etc_sysconfig_network_scripts_ifcfg_enp0(
    fedora_34_individual_network,
):
    """
    ...
    """
    builder = fedora_34_individual_network(public=False)
    tasks = builder.render()
    result = dedent(
        """\
        DEVICE=enp0
...
def test_fedora_34_private_alias_task_etc_sysconfig_network_scripts_ifcfg_enp0_0(
    fedora_34_individual_network,
):
    """
...
def test_fedora_34_private_alias_task_missing_for_private_only_enp(
    fedora_34_individual_network,
):
    """
...
def test_fedora_34_private_route_task_etc_sysconfig_network_scripts_route_enp0(
    fedora_34_individual_network,
):
    """
...
# pylama:ignore=E501
def test_fedora_34_private_route_task_etc_sysconfig_network_scripts_route_enp0_with_custom_private_subnets(
    fedora_34_individual_network,
):
    """
    When using a public ip, the private ip is assigned as an alias, this
    ...
    builder = fedora_34_individual_network(public=True, metadata=subnets)
    tasks = builder.render()
    result = dedent(
        """\
...
def test_fedora_34_private_route_task_missing_for_private_only_enp(
    fedora_34_individual_network,
):
    """
...
def test_fedora_34_etc_resolvers_configured(fedora_34_individual_network, fake):
    """
    Validates /etc/resolv.conf is configured correctly
    """
    builder = fedora_34_individual_network()
    resolver1 = fake.ipv4()
    resolver2 = fake.ipv4()
...
def test_fedora_34_etc_hostname_configured(fedora_34_individual_network):
    """
...
def test_fedora_34_etc_hosts_configured(fedora_34_individual_network):
    """
...
def test_fedora_34_network_manager_is_disabled(fedora_34_individual_network):
    """
...
def test_fedora_34_persistent_interface_names_does_not_exist(
    fedora_34_individual_network,
):
    """
