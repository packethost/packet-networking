...
@pytest.fixture
def rhel_7_bonded_network(generic_redhat_bonded_network):
    def _builder(**kwargs):
        return generic_redhat_bonded_network("redhatenterpriseserver", "7", **kwargs)

    return _builder


def test_rhel_7_public_bonded_task_etc_sysconfig_network(rhel_7_bonded_network):
...
def test_rhel_7_private_bonded_task_etc_sysconfig_network(rhel_7_bonded_network):
    """Validates /etc/sysconfig/network for a private only bond"""
    builder = rhel_7_bonded_network(public=False)
    tasks = builder.render()
    result = dedent(
        """\
        NETWORKING=yes
...
# pylama:ignore=E501
def test_rhel_7_bonded_task_etc_modprobe_d_bonding(rhel_7_bonded_network):
    """Validates /etc/modprobe.d/bonding.conf has correct bonding mode"""
    builder = rhel_7_bonded_network()
    tasks = builder.render()
    result = dedent(
        """\
        alias bond0 bonding
...
def test_rhel_7_private_alias_task_missing_for_private_only_bond(rhel_7_bonded_network):
    """
...
def test_rhel_7_individual_interface_files_created(rhel_7_bonded_network):
    """
...
def test_rhel_7_etc_resolvers_configured(rhel_7_bonded_network, fake):
    """
...
def test_rhel_7_etc_hostname_configured(rhel_7_bonded_network):
    """
...
def test_rhel_7_etc_hosts_configured(rhel_7_bonded_network):
    """
...
def test_rhel_7_sbin_ifup_pre_local(rhel_7_bonded_network):
    """
...
def test_rhel_7_network_manager_is_disabled(rhel_7_bonded_network):
    """
...
def test_rhel_7_persistent_interface_names(rhel_7_bonded_network):
    """
