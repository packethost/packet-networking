...
def test_rhel_7_private_route_task_etc_sysconfig_network_scripts_route_enp0_with_custom_facility_ip_space_routes(
    rhel_7_individual_network
):
    """
    When using a public ip, the private ip is assigned as an alias, this
    ...
    builder = rhel_7_individual_network(public=True, metadata=routes)
    tasks = builder.render()
    result = dedent(
        """\
