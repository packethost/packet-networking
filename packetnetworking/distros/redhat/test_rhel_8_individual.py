...
@pytest.fixture
def rhel_8_individual_network(generic_redhat_individual_network):
    def _builder(**kwargs):
        return generic_redhat_individual_network("redhatenterprise", "8", **kwargs)

    return _builder


def test_rhel_8_public_individual_task_etc_sysconfig_network(rhel_8_individual_network):
...
def test_rhel_8_private_individual_task_etc_sysconfig_network_scripts_ifcfg_enp0(
    ...
    """
    builder = rhel_8_individual_network(public=False)
    tasks = builder.render()
    result = dedent(
        """\
        DEVICE=enp0
...
def test_rhel_8_etc_resolvers_configured(rhel_8_individual_network, fake):
    """
    Validates /etc/resolv.conf is configured correctly
    """
    builder = rhel_8_individual_network()
    resolver1 = fake.ipv4()
    resolver2 = fake.ipv4()
...
def test_rhel_8_etc_hostname_configured(rhel_8_individual_network):
    """
...
def test_rhel_8_etc_hosts_configured(rhel_8_individual_network):
    """
...
def test_rhel_8_network_manager_is_disabled(rhel_8_individual_network):
    """
...
def test_rhel_8_persistent_interface_names(rhel_8_individual_network):
    """
