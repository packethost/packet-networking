...
# pylama:ignore=E501
def test_scientific_7_private_route_task_etc_sysconfig_network_scripts_route_enp0_with_custom_private_subnets(
    scientific_7_individual_network,
):
    """
    When using a public ip, the private ip is assigned as an alias, this
    ...
    builder = scientific_7_individual_network(public=True, metadata=subnets)
    tasks = builder.render()
    result = dedent(
        """\
