...
def test_scientific_7_public_individual_task_etc_sysconfig_network(
    scientific_7_individual_network
):
    """Validates /etc/sysconfig/network for a public bond"""
    builder = scientific_7_individual_network(public=True)
...
def test_scientific_7_public_individual_task_etc_sysconfig_network_scripts_ifcfg_enp0(
    scientific_7_individual_network
):
...
def test_scientific_7_private_individual_task_etc_sysconfig_network_scripts_ifcfg_enp0(
    scientific_7_individual_network
):
    """
    ...
    """
    builder = scientific_7_individual_network(public=False)
    tasks = builder.render()
    result = dedent(
        """\
        DEVICE=enp0
...
def test_scientific_7_private_alias_task_etc_sysconfig_network_scripts_ifcfg_enp0_0(
    scientific_7_individual_network
):
    """
...
def test_scientific_7_private_alias_task_missing_for_private_only_enp(
    scientific_7_individual_network
):
    """
...
def test_scientific_7_private_route_task_etc_sysconfig_network_scripts_route_enp0(
    scientific_7_individual_network
):
    """
...
def test_scientific_7_private_route_task_etc_sysconfig_network_scripts_route_enp0_with_custom_facility_ip_space_routes(
    scientific_7_individual_network
):
    """
    When using a public ip, the private ip is assigned as an alias, this
    ...
    builder = scientific_7_individual_network(public=True, metadata=routes)
    tasks = builder.render()
    result = dedent(
        """\
...
def test_scientific_7_private_route_task_missing_for_private_only_enp(
    scientific_7_individual_network
):
    """
...
def test_scientific_7_etc_resolvers_configured(scientific_7_individual_network, fake):
    """
    Validates /etc/resolv.conf is configured correctly
    """
    builder = scientific_7_individual_network()
    resolver1 = fake.ipv4()
    resolver2 = fake.ipv4()
...
def test_scientific_7_etc_hostname_configured(scientific_7_individual_network):
    """
...
def test_scientific_7_etc_hosts_configured(scientific_7_individual_network):
    """
...
def test_scientific_7_network_manager_is_disabled(scientific_7_individual_network):
    """
...
def test_scientific_7_persistent_interface_names(scientific_7_individual_network):
    """
